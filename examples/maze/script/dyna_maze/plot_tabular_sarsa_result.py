...
from kyoka.algorithm.sarsa import Sarsa, SarsaTabularActionValueFunction, SarsaApproxActionValueFunction
...
class MazeApproxActionValueFunction(SarsaApproxActionValueFunction):
